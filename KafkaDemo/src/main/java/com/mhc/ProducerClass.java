...
public class ProducerClass {
    public static void main(String[] args) throws InterruptedException {
		 ...
		 */
        properties.put("metadata.broker.list", "sun:9092,moon:9092,jupiter:9092,neptune:9092");
         /*
		 ...
		 */
        properties.put("offsets.topic.num.partitions", 4);
        properties.put("partitioner.class", "com.mhc.LogPartition");
        /**
         * 3、通过配置文件，创建生产者
         */
        ...
        for (int num = 0; num < 1000; num++) {
             ...
             */
            //"注意：这里需要指定 partitionKey，用来配合自定义的MyLogPartitioner进行数据分发注意：
            producer.send(new KeyedMessage<String, String>(TOPIC, num + "", "appid" + UUID.randomUUID() + "chaoge"));
        }
